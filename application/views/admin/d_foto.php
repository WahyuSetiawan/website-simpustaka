<form action="<?php echo base_URL()?>admin/data_foto/upload" method="post" accept-charset="utf-8" enctype="multipart/form-data">	
<input type="hidden" name="idp" value="<?php echo $this->uri->segment(4)?>">

	<fieldset><legend>Foto for ID <?php echo $this->uri->segment(4)?></legend>

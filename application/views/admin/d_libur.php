...
<form action="<?php echo base_URL()?>apps/libur/cari" method="post">
...
<br><br>
	...
	<table width="100%"  class="table table-condensed">
		...
		<tr>
			...
			<td><?php echo tgl_panjang($b->tanggal, "lm")?></td>
			<td><?php echo $b->nama?></td>
			
			<td style="text-align: center">
			<a href="<?php echo base_URL()?>apps/libur/edt/<?php echo $b->id?>"><span class="icon-pencil">&nbsp;&nbsp;</span></a>  
			<a href="<?php echo base_URL()?>apps/libur/del/<?php echo $b->id?>" onclick="return confirm('Anda YAKIN menghapus data \n <?php echo $b->nama?>..?');"><span class="icon-remove">&nbsp;&nbsp;</span></a>
			</td>
		</tr>	
		<?php 
			}

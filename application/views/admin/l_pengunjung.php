...
<button class="btn btn-primary" type="button" onclick="window.open('<?php echo base_URL(); ?>cetak/kunjung_hari_ini', '_blank')">Cetak Hari Ini</button> <button class="btn btn-primary" type="button" onclick="window.open('<?php echo base_URL()?>apps/l_pengunjung#bulanan', '_self')">Laporan Bulanan</button>
<br>
	...
	<table style="width: 50%"  class="table table-condensed">
		...
		<tr>
			...
			<td style="text-align: center"><?php echo $cjkh->jkl?></td>
			<td style="text-align: center"><?php echo $cjkh->jkp?></td>
			<td style="text-align: center"><?php echo $cjkh->jkl?> orang</td>
		</tr>	
		<?php
		}
		?>
	...
	<table style="width: 50%"  class="table table-condensed">
		...
		<?php 
		$c_jen_hi 	= $this->db->query("SELECT SUM(IF( jenis =  'Siswa', 1, 0 ) ) AS siswa, SUM( IF( jenis =  'Guru/Karyawan', 1, 0 ) ) AS gk , SUM( IF( jenis =  'Umum', 1, 0 ) ) AS umum FROM t_pengunjung  WHERE LEFT(tgl, 10) = DATE(NOW()) ")->result();
	...
	<table style="width: 80%"  class="table table-condensed">
		...
		<tr>
			<td style="text-align: center">1</td>
			<td style="text-align: center"><?php echo $c_p1?></td>
			<td style="text-align: center"><?php echo $c_p2?></td>
			<td style="text-align: center"><?php echo $c_p3?></td>
			<td style="text-align: center"><?php echo $c_p4?></td>
			<td style="text-align: center"><?php echo $c_p5?></td>
		</tr>	
	</table>
	
	<hr id="bulanan" style="border-width: 3px; border-color: #000">
	<!-- BULANAN COYYYY -->
	<a class="btn btn-success" href="<?php echo base_URL()?>cetak/kunjung_bulan/<?php echo date('m')?>" target="_blank">Cetak Bulan  Ini</a>
	<div class="btn-group">
		<a class="btn btn-success dropdown-toggle" data-toggle="dropdown" href="<?php echo base_URL()?>cetak/kunjung_bulan/<?php echo date('m')?>">Cetak Bulan  <span class="caret"></span></a>
		<ul class="dropdown-menu">
			<li><a href="<?php echo base_URL()?>cetak/kunjung_bulan/1" target="_blank">Januari</a></li>
			<li><a href="<?php echo base_URL()?>cetak/kunjung_bulan/2" target="_blank">Februari</a></li>
			<li><a href="<?php echo base_URL()?>cetak/kunjung_bulan/3" target="_blank">Maret</a></li>
			<li><a href="<?php echo base_URL()?>cetak/kunjung_bulan/4" target="_blank">April</a></li>
			<li><a href="<?php echo base_URL()?>cetak/kunjung_bulan/5" target="_blank">Mei</a></li>
			<li><a href="<?php echo base_URL()?>cetak/kunjung_bulan/6" target="_blank">Juni</a></li>
			<li><a href="<?php echo base_URL()?>cetak/kunjung_bulan/7" target="_blank">Juli</a></li>
			<li><a href="<?php echo base_URL()?>cetak/kunjung_bulan/8" target="_blank">Agustus</a></li>
			<li><a href="<?php echo base_URL()?>cetak/kunjung_bulan/9" target="_blank">September</a></li>
			<li><a href="<?php echo base_URL()?>cetak/kunjung_bulan/10" target="_blank">Oktober</a></li>
			<li><a href="<?php echo base_URL()?>cetak/kunjung_bulan/11" target="_blank">November</a></li>
			<li><a href="<?php echo base_URL()?>cetak/kunjung_bulan/12" target="_blank">Desember</a></li>
		</ul>
	</div>

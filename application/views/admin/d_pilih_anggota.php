...
<form action="<?php echo base_URL()?>apps/trans/add" method="post" accept-charset="utf-8" enctype="multipart/form-data" name="f_pilih_anggota" onsubmit="return cek()" >	
...
<label style="width: 150px; float: left">Jumlah Buku</label><input class="span1" type="text" name="jml_buku" required> &nbsp;&nbsp;*) Maksimal <?php echo $q_instansi->maks_buku?><br>
...
function cek() {
	...
	if (x > <?php echo $q_instansi->maks_buku?>) {
	  alert("Maksimal jumlah peminjaman adalah <?php echo $q_instansi->maks_buku?> buku..!!");
	  return false;
	}
}
</script>
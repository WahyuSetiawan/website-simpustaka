...
<form action="<?php echo base_URL()?>apps/trans/cari" method="post">
...
<br><br>
	...
	<table width="100%"  class="table table-condensed">
		...
		<tr>
			...
			<td><?php echo $b->nama?> <b>(<?php echo $b->jml_pinjam?> buku)</b></td>
			<td style="text-align: center"><?php echo tgl_panjang($b->tgl_pinjam, "sm")?></td>
			<td style="text-align: center"><?php echo tgl_panjang($b->tgl_kembali, "sm")?></td>
			
			<td style="text-align: center">
			<a href="<?php echo base_URL()?>apps/trans/det/<?php echo $b->id_anggota?>"><span class="icon-th-list">&nbsp;&nbsp;</span></a>  
			</td>
		</tr>	
		<?php 
			}

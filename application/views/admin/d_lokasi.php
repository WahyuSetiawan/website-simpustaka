...
<form action="<?php echo base_URL()?>apps/r_lokasi/cari" method="post">
...
<br><br>
	...
	<table width="100%"  class="table table-condensed">
		...
		<tr>
			...
			<a href="<?php echo base_URL()?>apps/r_lokasi/edt/<?php echo $b->id?>"><span class="icon-pencil">&nbsp;&nbsp;</span></a>  
			<a href="<?php echo base_URL()?>apps/r_lokasi/del/<?php echo $b->id?>" onclick="return confirm('Anda YAKIN menghapus data \n <?php echo $b->nama?>..?');"><span class="icon-remove">&nbsp;&nbsp;</span></a>
			</td>
		</tr>	
		<?php 
			}

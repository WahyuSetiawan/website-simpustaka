...
?>
<form action="<?php echo base_URL()?>apps/anggota/<?php echo $act?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">	
<input type="hidden" name="idp" value="<?php echo $idp?>">

	<fieldset><legend>Form</legend>
	<?php echo $this->session->flashdata("k");?>
	<label style="width: 150px; float: left">ID Anggota</label><input class="span8" type="text" name="id_anggota" placeholder="ID Anggota" value="<?php echo $id_a?>" required><br>
	...
	<label style="width: 150px; float: left">Alamat</label><input class="span8" type="text" name="alamat" placeholder="Alamat" value="<?php echo $alamat?>" required><br>
	...
	<br>
	<label style="width: 150px; float: left">Tempat Tanggal Lahir</label><input class="span3" type="text" name="tmp_lahir" placeholder="Tempat Lahir" value="<?php echo $tmp_lahir?>" required>, 
